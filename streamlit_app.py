...
if result is not None:
    ...
    st.caption(
        "בשנים 2024-2026 לא היו נתוני הכנסה נטו קבוצתיים ולא היו נתוני צריכה קבוצתיים חדשים, ולכן שינוי "
        "ההכנסה נאמד באמצעות שינוי השכר הממוצע ברוטו במשק, והרכב הצריכה קובע לפי הנתונים האחרונים הזמינים "
        "לכל קבוצה. לפי אומדן המבוסס על מדרגות מס הכנסה ודמי ביטוח לאומי/בריאות סביב השכר הממוצע, תרגום "
        "שינוי הברוטו לנטו מפחית את מדד כוח הקניה בכ-0.9% בשנת 2024, בכ-1.5% בשנת 2025 ובכ-2.1% בשנת 2026. "
        "מדד המחירים האישי אינו מושפע מהתאמת הברוטו לנטו, אך הוא כן ממשיך להתבסס על הרכב הצריכה האחרון הזמין."
    )
